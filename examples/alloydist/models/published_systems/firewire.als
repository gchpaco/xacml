...
module published_systems/firewire
open std/ord
...
run Execution for 1 Ord[State], 1 Int, 7 Op, 2 Msg,
	2 Node, 4 Link, 4 Queue, 6 State

-- solution for 3 State but not for 4 State
run NoRepeats for 1 Ord[State], 1 Int, 6 Op, 2 Msg,
...
check NoOverflow for 1 Ord[State], 1 Int, 6 Op, 2 Msg,
	3 Node, 6 Link, 5 Queue, 9 State

check AtMostOneElected for 1 Ord[State], 1 Int, 6 Op, 2 Msg,
	3 Node, 6 Link, 3 Queue, 9 State

check OneEventuallyElected for 1 Ord[State], 1 Int, 6 Op, 2 Msg,
	3 Node, 6 Link, 3 Queue, 9 State
