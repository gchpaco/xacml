...
@MACRO makeSizedString = (r ? scheme_make_sized_string(r, _x0, 0) : XC_SCHEME_NULL)
...
@MACRO makeSizedStringX = (r ? scheme_make_sized_string(r, _x0 - 1, 0) : XC_SCHEME_NULL)

@ "get-string" : nstring/makeSizedStringX GetString(nnlong?=NULL); : : /alwaysPassPtr/
