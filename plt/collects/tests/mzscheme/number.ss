...
(err/rt-test (/ 0) exn:application:divide-by-zero?)
(err/rt-test (/ 1 0) exn:application:divide-by-zero?)
(err/rt-test (/ 1/2 0) exn:application:divide-by-zero?)
(err/rt-test (/ 1+2i 0) exn:application:divide-by-zero?)
(err/rt-test (/ 1.0 0) exn:application:divide-by-zero?)
...
(err/rt-test (quotient 6 0) exn:application:divide-by-zero?)
(err/rt-test (modulo 6 0) exn:application:divide-by-zero?)
(err/rt-test (remainder 6 0) exn:application:divide-by-zero?)
(err/rt-test (quotient 6 0.0) exn:application:divide-by-zero?)
(err/rt-test (modulo 6 0.0) exn:application:divide-by-zero?)
(err/rt-test (remainder 6 0.0) exn:application:divide-by-zero?)
(err/rt-test (quotient 6 -0.0) exn:application:divide-by-zero?)
(err/rt-test (modulo 6 -0.0) exn:application:divide-by-zero?)
(err/rt-test (remainder 6 -0.0) exn:application:divide-by-zero?)
...
(err/rt-test (arithmetic-shift 1 (expt 2 80)) exn:misc:out-of-memory?)
...
(err/rt-test (angle 'a))
(err/rt-test (angle 0) exn:application:divide-by-zero?)
...
(test 2.0+0.0i integer-sqrt 5.0+0.0i)
(test 0+2.0i integer-sqrt -5.0+0.0i)
...
(test '(2.0+0.0i 1.0+0.0i) call-with-values (lambda () (integer-sqrt/remainder 5.0+0.0i)) list)
(test '(0+2.0i -1.0+0.0i) call-with-values (lambda () (integer-sqrt/remainder -5.0+0.0i)) list)
...
(err/rt-test (expt 0 -1) exn:application:divide-by-zero?)
(err/rt-test (expt 0 -1.0) exn:application:divide-by-zero?)
(err/rt-test (expt 0 -inf.0) exn:application:divide-by-zero?)
(err/rt-test (expt 0 -1+2i) exn:application:divide-by-zero?)
(err/rt-test (expt 0 -1.0+2i) exn:application:divide-by-zero?)
(err/rt-test (expt 0 0+2i) exn:application:divide-by-zero?)
(err/rt-test (expt 0 0.0+2i) exn:application:divide-by-zero?)
(err/rt-test (expt 0 -0.0+2i) exn:application:divide-by-zero?)
(err/rt-test (expt 0 0+0.0i) exn:application:divide-by-zero?)
...
(test 0.0 atan 0.0 0)
(err/rt-test (atan 0 0) exn:application:divide-by-zero?)
...
(test -inf.0 log 0.0)
(test -inf.0 log -0.0)
(err/rt-test (log 0) exn:application:divide-by-zero?)
