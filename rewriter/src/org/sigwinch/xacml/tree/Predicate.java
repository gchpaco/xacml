...
abstract public class Predicate {
    ...
    static {
        ...
        type2string.put("http://www.w3.org/2001/XMLSchema#string", "String");
        type2string.put("http://www.w3.org/2001/XMLSchema#integer", "Integer");
        type2string.put("http://www.w3.org/2001/XMLSchema#date", "Date");
        type2string.put("http://www.w3.org/2001/XMLSchema#boolean", "Bool");
        type2string.put("http://www.w3.org/TR/2002/WD-xquery-operators"
                + "-20020816#yearMonthDuration", "YearMonthDuration");
        // TODO: fill in rest
    ...
    public Predicate not() {
        ...
        return new FunctionCallPredicate(notString, new Predicate[] { this });
    }
