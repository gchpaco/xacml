...
public class ExistentialPredicate extends Predicate {
     ...
     *
     * @param argAttribute Value to assign to this.attribute
     */
     ...
     *
     * @param argBag Value to assign to this.bag
     */
     ...
     * @param newFunction The new Function value.
     */
	...
	return function.equals (e.getFunction ()) &&
	    attribute.equals (e.getAttribute ()) && 
	    bag.equals (e.getBag ());
    }
