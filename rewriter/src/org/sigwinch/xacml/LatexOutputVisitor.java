...
public class LatexOutputVisitor implements Visitor {
    ...
    public void walkPermitOverridesRule(PermitOverridesRule permitOverridesRule) {
        printRule("\\oplus", permitOverridesRule.getLeft(), permitOverridesRule
                .getRight(), permitOverridesRule);
    }
    ...
    public void walkDenyOverridesRule(DenyOverridesRule denyOverridesRule) {
        printRule("\\ominus", denyOverridesRule.getLeft(), denyOverridesRule
                .getRight(), denyOverridesRule);
    }
    ...
    public void walkOnlyOneRule(OnlyOneRule onlyOneRule) {
        printRule("\\otimes", onlyOneRule.getLeft(), onlyOneRule.getRight(),
                onlyOneRule);
    }
    ...
    /**
     * Write the given <code>AndPredicate</code> node to <code>stream</code>.
     * 
     * @param andPredicate
     *            node to write
     */
    ...
    public void walkExistentialPredicate(
        ...
        new FunctionCallPredicate(existentialPredicate.getFunction(),
                new Predicate[] { new VariableReference("x_{" + myvar + "}"),
    ...
    /**
     * Write the given <code>SolePredicate</code> node to <code>stream</code>.
     * 
     * @param solePredicate
     *            node to write
     */
