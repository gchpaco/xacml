...
public class Propagator extends TransformerImpl {
	...
	if (scope.getChild () instanceof Error) {
	    ...
	    return new FirstApplicableRule (new Scope (p.getLeft (),
						       scope.getCondition ())
					    .transform (this),
					    new Scope (p.getRight (),
						       scope.getCondition ())
	    ...
	    return new OnlyOneRule (new Scope (p.getLeft (),
					       scope.getCondition ())
				    .transform (this),
				    new Scope (p.getRight (),
					       scope.getCondition ())
