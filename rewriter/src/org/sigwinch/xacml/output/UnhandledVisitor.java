...
public class UnhandledVisitor extends CodeVisitor {
    ...
    public void walkExistentialPredicate(
        ...
        UnhandledFunctionVisitor v = new UnhandledFunctionVisitor(this);
        v.visitFunction(existentialPredicate.getFunction(), new Predicate[] {
                new VariableReference("x" + existentialPredicate.getIndex()),
                existentialPredicate.getAttribute() }, existentialPredicate
                .getIndex());
    }
