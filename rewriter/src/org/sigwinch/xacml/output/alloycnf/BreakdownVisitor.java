...
public class BreakdownVisitor extends CodeVisitor {
    ...
    public Map<Predicate, String> getMap() {
        return map;
    }
    ...
    public void walkExistentialPredicate(ExistentialPredicate pred) {
        BreakdownExistentialFV v = new BreakdownExistentialFV(this, pred);
    ...
    public void walkFunctionCallPredicate(
        ...
        BreakdownFunctionVisitor v = new BreakdownFunctionVisitor(this,
    ...
    class BreakdownExistentialFV extends FunctionVisitorImpl {
        ...
        BreakdownExistentialFV(Visitor visitor, ExistentialPredicate predicate) {
            super(visitor);
            this.expr = -1;
