...
public class AttributeParser extends ExpressionParser {
    ...
    /**
     * Read an attribute from an EnvironmentAttributeDesignator node or the
     * like.
     * 
     * @param element
     *            XML tree containing the attribute designator
    ...
    public Predicate parseElement(Element element) {
        ...
        if (element.getNodeName().equals("SubjectAttributeDesignator")) {
            ...
            if (category != null)
                ...
                category = "urn:oasis:tc:xacml:1.0:subject-category:access-subject";
            id = category + "::" + id;
        }
