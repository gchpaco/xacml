...
public class RuleParser extends AbstractParser {
    ...
    /**
     * Reads the given <code>Rule</code> node and creates and returns
     * an appropriate <code>Tree</code>.
     *
     * @param element an <code>Element</code> representing a <code>Rule</code> node
