...
public class PolicyParser extends AbstractParser {
    ...
    /**
     * Reads the given <code>Policy</code> node and creates and returns an
     * appropriate <code>Tree</code>. This reads the RuleCombiningAlgId
     * attribute.
     * 
     * @param element
     *            an <code>Element</code> representing a <code>Policy</code>
     *            node
