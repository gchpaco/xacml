...
public class StructurePreservingConversionTest extends TestCase {
    ...
    public void testAnd () {
        ...
        BooleanFormula conversion = StructurePreservingConverter.convert (formula);
        assertEquals (new And (new Implication (var, new And (a.negate (), b)),
                               var), conversion);
        conversion = StructurePreservingConverter.convert (formula.negate ());
        assertEquals (new And (new Implication (new And (a.negate (), b), var),
                               var.negate ()), conversion);
    }
    ...
    public void testOr () {
        ...
        VariableReference var = new VariableReference ("clause_1");
        BooleanFormula conversion = StructurePreservingConverter.convert (formula);
        assertEquals (new And (new Implication (var, new Or (a.negate (), b)),
                               var), conversion);
        conversion = StructurePreservingConverter.convert (formula.negate ());
        assertEquals (new And (new Implication (new Or (a.negate (), b), var),
                               var.negate ()), conversion);
    }
    ...
    public void testEquivalence () {
        ...
        VariableReference var = new VariableReference ("clause_1");
        BooleanFormula conversion = StructurePreservingConverter.convert (formula);
        assertEquals (new And (new Implication (var, new Equivalence (a.negate (), b)),
                               var), conversion);
        conversion = StructurePreservingConverter.convert (formula.negate ());
        assertEquals (new And (new Implication (new Equivalence (a.negate (), b), var),
                               var.negate ()), conversion);
    }
    ...
    public void testImplication () {
        ...
        VariableReference var = new VariableReference ("clause_1");
        BooleanFormula conversion = StructurePreservingConverter.convert (formula);
        assertEquals (new And (new Implication (var, new Implication (a.negate (), b)),
                               var), conversion);
        conversion = StructurePreservingConverter.convert (formula.negate ());
        assertEquals (new And (new Implication (new Implication (a.negate (), b), var),
                               var.negate ()), conversion);
    }
    ...
    public void testSimpleConverter () {
        ...
        assertArraysEqual (new int[][] { { -1, -2 }, { -2, 3 }, { 2 } },
                           result);
    }

    public void testEquivalences () {
        BooleanFormula formula = new Equivalence (new VariableReference ("a"), new VariableReference ("b"));
        int[][] result = StructurePreservingConverter.toArray (formula);
