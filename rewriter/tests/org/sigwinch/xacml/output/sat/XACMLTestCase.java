...
public abstract class XACMLTestCase extends TestCase {
     ...
     * @param t
     */
    protected void assertTriple(BooleanFormula f1, BooleanFormula f2,
            BooleanFormula f3, Triple t) {
        assertTriple(f1, f2, f3, t, new BooleanFormula[] {});
    }

    protected void assertTriple(BooleanFormula f1, BooleanFormula f2,
            BooleanFormula f3, Triple t, BooleanFormula[] frames) {
        ...
        assertNotNull(deny);
        assertNotNull(error);
        TreeSet<BooleanFormula> formulas = new TreeSet<BooleanFormula>(
    ...
    protected FunctionCallPredicate buildFunction(String function,
            Predicate[] predicates) {
        return new FunctionCallPredicate(xp + function, predicates);
    }

    protected ExistentialPredicate buildExistential(String function,
            Predicate attribute, Predicate bag) {
        return new ExistentialPredicate(xp + function, attribute, bag);
    }

    protected BooleanFormula[] buildEquivalence(BooleanFormula[] foos,
            BooleanFormula[] bars) {
