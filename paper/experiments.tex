...
\caption{Verification performance for the 
  properties of the \textsc{Continue} conference manager (C1-11), Medico (M1-2) and
  voting (V1) examples. 
  We divided the execution time to I/O, transformation
...
We tested 11 properties, labeled C1, C2, and so on, for subsumption
